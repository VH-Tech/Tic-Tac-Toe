...
lbl = Label(tk, text="Tic-Tac-Toe", font=("Arial Bold", 50)).grid(row=0 , column=2)


btn1 = Button(tk, text="", command=lambda: box(btn1), font=("Arial Bold", 30), bg="black", fg="white", width=6, height=5)
btn1.grid(row=2, column=1, sticky="nsew")

btn2 = Button(tk, text="", command=lambda: box(btn2), font=("Arial Bold", 30), bg="black", fg="white", width=6, height=5)
btn2.grid(row=2, column=2, sticky="nsew")


btn3 = Button(tk, text="", command=lambda: box(btn3), font=("Arial Bold", 30), bg="black", fg="white", width=6, height=5)
btn3.grid(row=2, column=3, sticky="nsew")


btn4 = Button(tk, text="", command=lambda: box(btn4), font=("Arial Bold", 30), bg="black", fg="white", width=6, height=5)
btn4.grid(row=3, column=1, sticky="nsew")


btn5 = Button(tk, text="", command=lambda: box(btn5), font=("Arial Bold", 30), bg="black", fg="white", width=6, height=5)
btn5.grid(row=3, column=2, sticky="nsew")


btn6 = Button(tk, text="", command=lambda: box(btn6), font=("Arial Bold", 30), bg="black", fg="white", width=6, height=5)
btn6.grid(row=3, column=3, sticky="nsew")


btn7 = Button(tk, text="", command=lambda: box(btn7), font=("Arial Bold", 30), bg="black", fg="white", width=6, height=5)
btn7.grid(row=4, column=1, sticky="nsew")


btn8 = Button(tk, text="", command=lambda: box(btn8), font=("Arial Bold", 30), bg="black", fg="white", width=6, height=5)
btn8.grid(row=4, column=2, sticky="nsew")


btn9 = Button(tk, text="", command=lambda: box(btn9), font=("Arial Bold", 30), bg="black", fg="white", width=6, height=5)
