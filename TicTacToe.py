...
def main():
    ...
    lbl = Label(tk, text="TicTacToe", font=("Arial Bold", 20)).grid(row=0, column=1)

    btn1 = Button(tk, text=" ", font='Arial 20 bold', bg='black', fg='white', height=4, width=8,
                     command=lambda: box(btn1))
    btn1.grid(row=3, column=0)

    btn2 = Button(tk, text=' ', font='Arial 20 bold', bg='black', fg='white', height=4, width=8,
                     command=lambda: box(btn2))
    btn2.grid(row=3, column=1)

    btn3 = Button(tk, text=' ', font='Arial 20 bold', bg='black', fg='white', height=4, width=8,
                     command=lambda: box(btn3))
    btn3.grid(row=3, column=2)

    btn4 = Button(tk, text=' ', font='Arial 20 bold', bg='black', fg='white', height=4, width=8,
                     command=lambda: box(btn4))
    btn4.grid(row=4, column=0)

    btn5 = Button(tk, text=' ', font='Arial 20 bold', bg='black', fg='white', height=4, width=8,
                     command=lambda: box(btn5))
    btn5.grid(row=4, column=1)

    btn6 = Button(tk, text=' ', font='Arial 20 bold', bg='black', fg='white', height=4, width=8,
                     command=lambda: box(btn6))
    btn6.grid(row=4, column=2)

    btn7 = Button(tk, text=' ', font='Arial 20 bold', bg='black', fg='white', height=4, width=8,
                     command=lambda: box(btn7))
    btn7.grid(row=5, column=0)

    btn8 = Button(tk, text=' ', font='Arial 20 bold', bg='black', fg='white', height=4, width=8,
                     command=lambda: box(btn8))
    btn8.grid(row=5, column=1)

    btn9 = Button(tk, text=' ', font='Arial 20 bold', bg='black', fg='white', height=4, width=8,
